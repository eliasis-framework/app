...
* Added   `Eliasis\App\App->runErrorHandler()` method.
* Added   `Eliasis\App\App->runCleaner()` method.
* Added   `Eliasis\App\App->runHooks()` method.
* Added   `Eliasis\App\App->runModules()` method.
* Added   `Eliasis\App\App->runRoutes()` method.
